...
class MapGraph {
 public:
  ...
  friend TensorGraphDataLaneLane getLaneLaneData(MapGraphConstPtr localSubmapGraph,
                                                 const LaneletRepresentationType& reprType,
                                                 const ParametrizationType& paramType, int nPoints, int noRelTypes,
                                                 int noBdTypes);
  friend TensorGraphDataLaneTE getLaneTEData(MapGraphConstPtr localSubmapGraph,
                                             const LaneletRepresentationType& reprType,
                                             const ParametrizationType& paramType, int nPoints, int noRelTypes,
                                             int noBdTypes);

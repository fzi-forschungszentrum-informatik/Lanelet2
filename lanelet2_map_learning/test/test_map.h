...
class MapTestData {
 ...
 private:
  void initPoints() {
    ...
    addPoint(6.0, 1.0, 1.0);
    addPoint(8.0, 1.0, 1.0);  // p9
    addPoint(0.0, 2.0, 1.0);
    addPoint(2.0, 2.0, 1.0);
    addPoint(4.0, 2.0, 1.0);
    addPoint(6.0, 2.0, 1.0);
    addPoint(8.0, 2.0, 1.0);
    addPoint(10.0, 2.0, 1.0);
    addPoint(12.0, 2.0, 1.0);
    addPoint(14.0, 2.0, 1.0);  // p17
    addPoint(6.0, 3.0, 1.0);
    addPoint(8.0, 3.0, 1.0);  // p19
    addPoint(0.0, 4.0, 1.0);
  ...
  void initLineStrings() {
    lines.clear();
    addLine(Points3d{points.at(7), points.at(6), points.at(5)});  // l1000
    lines.at(1000).setAttribute(AttributeName::Type, AttributeValueString::RoadBorder);
    addLine(Points3d{points.at(5), points.at(4), points.at(3), points.at(2)});  // l1001
    lines.at(1001).setAttribute(AttributeName::Type, AttributeValueString::RoadBorder);
    addLine(Points3d{points.at(2), points.at(1), points.at(0)});  // l1002
    lines.at(1002).setAttribute(AttributeName::Type, AttributeValueString::RoadBorder);

    addLine(Points3d{points.at(17), points.at(16), points.at(15)});  // l1003
    lines.at(1003).setAttribute(AttributeName::Type, AttributeValueString::LineThin);
    lines.at(1003).setAttribute(AttributeName::Subtype, AttributeValueString::Solid);
    addLine(Points3d{points.at(15), points.at(14), points.at(13), points.at(12)});  // l1004
    lines.at(1004).setAttribute(AttributeName::Type, AttributeValueString::LineThin);
    lines.at(1004).setAttribute(AttributeName::Subtype, AttributeValueString::Dashed);
    addLine(Points3d{points.at(12), points.at(11), points.at(10)});  // l1005
    lines.at(1005).setAttribute(AttributeName::Type, AttributeValueString::LineThin);
    lines.at(1005).setAttribute(AttributeName::Subtype, AttributeValueString::Solid);
    ...
    addLine(Points3d{points.at(30), points.at(19), points.at(8), points.at(2)});  // l1018
    lines.at(1018).setAttribute(AttributeName::Type, AttributeValueString::Virtual);
    addLine(Points3d{points.at(5), points.at(9), points.at(18), points.at(28)});  // l1019
    lines.at(1019).setAttribute(AttributeName::Type, AttributeValueString::Virtual);
    addLine(Points3d{points.at(15), points.at(19), points.at(29)});  // l1020
    lines.at(1020).setAttribute(AttributeName::Type, AttributeValueString::Virtual);
  }
  void initLanelets() {
    lanelets.clear();
